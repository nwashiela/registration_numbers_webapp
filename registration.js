...
module.exports = function (pool) {
    ...
    async function setRegNumbers(number) {
      ...
      if(keepReg === 0){ 
        await pool.query('insert into registration_numbers(regnumbers, allreg_id) values ($1, $2)', [number, townId]);
    ...
    let rNumber = await pool.query('select regnumbers from registration_numbers where regnumbers = $1',[reg])
